...
ruby tools/ifdef_cleaner.rb --def=VM_MIXEDMAP,ALL_VERSIONS --undef=VM_XIP --kernel_version=2.6.27 --input_file=fs/axfs/axfs.h --output_file=../branches/linux/fs/axfs/axfs.h
