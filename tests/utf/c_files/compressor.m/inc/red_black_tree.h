...
typedef struct rb_red_blk_tree {
  ...
  /*  A sentinel is used for root and for nild.  These sentinels are */
  /*  created when RBTreeCreate is caled.  root->left should always */
  /*  point to the node which is the root of the tree.  nild points to a */
  /*  node which should always be black but has aribtrary children and */
  /*  parent and no key or info.  The point of using these sentinels is so */
  /*  that the root and nild nodes do not require special cases in the code */
  rb_red_blk_node* root;             
  rb_red_blk_node* nild;              
} rb_red_blk_tree;

void RBTreeCreate(rb_red_blk_tree *,
			     rb_red_blk_node* nild,
			     rb_red_blk_node* root,
			     ...
			     void (*PrintInfo)(void*));
void RBTreeInsert(rb_red_blk_node*, rb_red_blk_tree*, void* key, void* info);
